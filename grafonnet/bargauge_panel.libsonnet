{
  /**
   * Returns a new bargauge panel that can be added in a row.
   * It requires the bargauge panel plugin in grafana, which is built-in.
   *
   * @param title The title of the bargauge panel.
   ...
   * @param repeat Variable used to repeat the bargauge panel
   ...
   * @return A json that represents a bargauge panel
   */
  new(
    title,
    span=null,
